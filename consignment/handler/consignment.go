...
import (
	...
	logPB "github.com/Martin1992-ss/deMicro/interface-center/out/log"

	"github.com/Martin1992-ss/deMicro/config"
	"github.com/Martin1992-ss/deMicro/consignment/model"
...
//Handler  微服务服务端 struct handler 必须实现 protobuf 中定义的 rpc 方法
